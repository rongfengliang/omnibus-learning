...
```shell
$ bin/omnibus clean vigil
```

Adding the `--purge` purge option removes __ALL__ files generated during the
build including the project install directory (`/opt/vigil`) and
the package cache directory (`/var/cache/omnibus/pkg`):

```shell
$ bin/omnibus clean vigil --purge
```
...
[vagrant@ubuntu...] $ cd vigil
[vagrant@ubuntu...] $ bundle install
[vagrant@ubuntu...] $ ...
[vagrant@ubuntu...] $ bin/omnibus build vigil
```
